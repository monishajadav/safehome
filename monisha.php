...
<head>
  ...
  <title>Monisha Jadav A.S — Portfolio</title>
...
<body>
  ...
  <!-- NAV -->
  <nav>
    <div class="nav-logo">Monisha Jadav A.S</div>
    <ul class="nav-links">
  ...
  <section class="hero" id="home">
    <div class="hero-content">
      ...
      <h1>Monisha<br/><em>Jadav A.S</em></h1>
      <p class="hero-subtitle">
        BCA Final Year Student · Web Developer · Building full-stack solutions with HTML, CSS, JavaScript, PHP & MySQL.
      </p>
      <div class="hero-btns">
  ...
  <section id="about">
    ...
    <div class="about-grid">
      <div class="about-text">
        <p>
          I'm a final-year BCA student from Alvas Degree College, Moodubidri, passionate about building meaningful web applications that solve real problems. With hands-on experience in full-stack web development, I enjoy turning ideas into polished digital products.
        </p>
        <p>
          I had the opportunity to intern at Vivarrathna Technologies, where I developed responsive web pages and collaborated on team projects. Currently, I'm building a full-stack NGO platform called <strong style="color:var(--gold)">Safe & Home Foundation</strong> — one of my most ambitious projects yet.
        </p>
        <p>
          I thrive in collaborative environments and am always eager to pick up new technologies, write clean code, and grow as a developer.
        </p>
      </div>
      <div>
        <div class="about-info">
          <div class="info-item"><span class="label">Name</span><span class="value">Monisha Jadav A.S</span></div>
          ...
          <div class="info-item"><span class="label">Location</span><span class="value">Bangalore Urban, Karnataka</span></div>
          <div class="info-item"><span class="label">Email</span><span class="value">jadavmonisha418@gmail.com</span></div>
          <div class="info-item"><span class="label">Phone</span><span class="value">+91 83104 15946</span></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="skills" class="skills-section">
    ...
    <div class="skills-grid">
      ...
      <div class="skill-card">
        <div class="skill-category">🗃️ Database & Server</div>
        <div class="skill-tags">
      ...
      <div class="skill-card">
        <div class="skill-category">🛠️ Tools & OS</div>
        <div class="skill-tags">
  ...
  <section id="projects">
    ...
    <div class="projects-grid">
      ...
      <div class="project-card">
        <div class="project-banner banner-food">🍽️</div>
        <div class="project-body">
          <div class="project-title">Online Food Ordering System</div>
          <p class="project-desc">
            A web-based application for placing and managing food orders. Includes cart integration and an admin panel for restaurant management, built with PHP and MySQL backend.
          </p>
          <div class="project-stack">
            <span class="stack-pill">HTML</span>
            <span class="stack-pill">CSS</span>
 ...
 <section id="experience" class="experience-section">
  ...
  <div class="exp-card">
    <div class="exp-header">
      <div>
        <div class="exp-company">Vivarrathna Technologies Pvt. Ltd.</div>
        <div class="exp-role">Web Development Intern</div>
      </div>
      <div class="exp-date">July 2025 – Aug 2025</div>
    </div>
    <ul class="exp-bullets">
      <li>Assisted in developing and maintaining responsive web pages using HTML, CSS, JavaScript, and PHP.</li>
      <li>Collaborated with a team to design and test web application features.</li>
      <li>Improved website performance and resolved front-end bugs.</li>
    </ul>
  </div> 
  ...
  <div class="exp-card" style="margin-top: 1.5rem;">
    <div class="exp-header">
      <div>
        <div class="exp-company">Sambhav Foundation – NGO</div>
        <div class="exp-role">Web Development Intern & Cybersecurity</div>
      </div>
  ...
  <section id="education">
    ...
    <div class="edu-grid">
      ...
      <div class="edu-card">
        <div class="edu-degree">Commerce — CEBA Stream (PUC)</div>
        <div class="edu-inst">KLE Independent PU College, Nagarbhavi</div>
    ...
    <div class="cert-list">
      <div class="cert-item">
        ...
        <div>
          ...
          <div class="cert-org">Certification Course</div>
        </div>
      </div>
      <div class="cert-item">
        <div class="cert-icon">🎖️</div>
        <div>
          <div class="cert-name">Web Development Internship Certificate</div>
          <div class="cert-org">Vivarrathna Technologies Pvt. Ltd.</div>
        </div>
      </div>
      <div class="cert-item">
        <div class="cert-icon">🛡️</div>
        <div>
          <div class="cert-name">Cybersecurity Certification</div>
          <div class="cert-org">Sambhav Foundation – NGO</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="contact" class="contact-section">
    ...
    <div class="contact-links">
      <a href="mailto:jadavmonisha418@gmail.com" class="contact-link">
        ✉️ jadavmonisha418@gmail.com
      </a>
      <a href="tel:+918310415946" class="contact-link">
        📞 +91 83104 15946
      </a>
  ...
  <!-- FOOTER -->
  <footer>
    <p>© 2025 Monisha Jadav A.S · Crafted with ❤️ using HTML, CSS & JavaScript</p>
  </footer>
