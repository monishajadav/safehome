...
<head>
  ...
  <title>P K Aishwarya — Portfolio</title>
  <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,700;1,400&family=DM+Sans:wght@300;400;500&display=swap" rel="stylesheet"/>
  <style>
    :root{
  --bg: #f6e206;          /* page background */
  --surface: #f1f3f5;     /* section background */
  --card: #1f2937;        /* cards */
  --gold: #0f0d0f;        /* main accent (blue) */
  --gold-light: #93c5fd;  
  --text: #f8fafc;        /* main text */
  --muted: #94a3b8;       /* secondary text */
  --border: rgba(219, 9, 9, 0.18);
  --radius: 12px;
}
...
<body>
  ...
  <!-- NAV -->
  <nav>
    <div class="nav-logo">P K Aishwarya</div>
    <ul class="nav-links">
  ...
  <section class="hero" id="home">
    <div class="hero-content">
      ...
      <h1>G P<br/><em>Krishnaveni</em></h1>
      <p class="hero-subtitle">
        BCA Final Year Student · python · building skills(programming and coding) .
      </p>
      <div class="hero-btns">
  ...
  <section id="about">
    ...
    <div class="about-grid">
      <div class="about-text">
        ...
        <p>
          I have done my intership in National Thermal Power Corporation Limited . Currently, I'm doing documentation in full-stack NGO platform called <strong style="color:var(--gold)">Safe & Home Foundation</strong> — one of my most ambitious projects yet.
        </p>
        <p>
      ...
      <div>
        <div class="about-info">
          <div class="info-item"><span class="label">Name</span><span class="value">G P Krishnaveni</span></div>
          ...
          <div class="info-item"><span class="label">Location</span><span class="value">Hubballi</span></div>
          <div class="info-item"><span class="label">Email</span><span class="value">krishnavenigondkar@gmail.com</span></div>
          <div class="info-item"><span class="label">Phone</span><span class="value">+91 9036933294</span></div>
        </div>
      </div>
    </div>
  </section>
 ...
 <section id="experience" class="experience-section">
  ...
  <div class="exp-card">
    <div class="exp-header">
      <div>
        <div class="exp-company">Great Learning</div>
        <div class="exp-role">Python -Begineers Intern</div>
      </div>
      <div class="exp-date">March-2024</div>
    </div>
    <ul class="exp-bullets">
      <li>Assisted in developing the basic python code .</li>
    </ul>
  </div> 
  ...
  <div class="exp-card" style="margin-top: 1.5rem;">
    <div class="exp-header">
      <div>
        <div class="exp-company">NTPC limited</div>
        <div class="exp-role">worked as intern </div>
      </div>
  ...
  <section id="education">
    ...
    <div class="edu-grid">
      ...
      <div class="edu-card">
        ...
        <div class="edu-inst">Ranjeetmal Gandhi College</div>
    ...
    <div class="cert-list">
      <div class="cert-item">
        ...
        <div>
          <div class="cert-name">NTPC limited</div>
          <div class="cert-org">Intern and Data Entry</div>
        </div>
      </div>
      <div class="cert-item">
        <div class="cert-icon">🎖️</div>
        <div>
          <div class="cert-name">Great Learning</div>
          <div class="cert-org">Python begineers-intern </div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="contact" class="contact-section">
    ...
    <div class="contact-links">
      <a href="mailto:prarthana359@gmail.com" class="contact-link">
        ✉️ krishnavenigondkar@gmail.com
      </a>
      <a href="tel:+919082800656" class="contact-link">
        📞 +91 9036933294
      </a>
      </a>
      <a href=www.linkedin.com/in/krishnaveni3012
 target="_blank" class="contact-link">
  ...
  <!-- FOOTER -->
  <footer>
    <p>© 2025 G P Krishnaveni· Crafted with ❤️ using HTML, CSS & JavaScript</p>
  </footer>
