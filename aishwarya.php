...
<head>
  ...
  --surface: #161b22;     /* section background */
  --card: #1f2937;        /* cards */
  --gold: #60a5fa;        /* main accent (blue) */
  --gold-light: #93c5fd;  
...
<body>
  ...
  <section id="about">
    ...
    <div class="about-grid">
      <div class="about-text">
        ...
        <p>
          I have done my intership in Aishwarya Engineers . Currently, I'm doing documentation in full-stack NGO platform called <strong style="color:var(--gold)">Safe & Home Foundation</strong> — one of my most ambitious projects yet.
        </p>
        <p>
      ...
      <div>
        <div class="about-info">
          <div class="info-item"><span class="label">Name</span><span class="value">P K Aishwarya</span></div>
          ...
          <div class="info-item"><span class="label">Location</span><span class="value">Raybag</span></div>
          <div class="info-item"><span class="label">Email</span><span class="value">aishhuuu22@gmail.com</span></div>
          <div class="info-item"><span class="label">Phone</span><span class="value">+91 6362001047</span></div>
        </div>
      </div>
    </div>
  </section>
 ...
 <section id="experience" class="experience-section">
  ...
  <div class="exp-card">
    <div class="exp-header">
      <div>
        ...
        <div class="exp-role">Cloud Computing -Begineers Intern</div>
      </div>
      <div class="exp-date">February-2024</div>
    </div>
    <ul class="exp-bullets">
      <li>Assisted in developing and maintaining Cloud Computing platfrom.</li>
    </ul>
  </div> 
  ...
  <div class="exp-card" style="margin-top: 1.5rem;">
    <div class="exp-header">
      <div>
        <div class="exp-company">Aishwarya Engineers</div>
        <div class="exp-role">worked as data mining-data entry </div>
      </div>
  ...
  <section id="education">
    ...
    <div class="edu-grid">
      ...
      <div class="edu-card">
        <div class="edu-degree">Science (PUC)</div>
        <div class="edu-inst">KLE Independent college</div>
    ...
    <div class="cert-list">
      <div class="cert-item">
        ...
        <div>
          <div class="cert-name">Aishwarya Engineers</div>
          <div class="cert-org">Data mininig & Data Entry</div>
        </div>
      </div>
      <div class="cert-item">
        ...
        <div>
          ...
          <div class="cert-org">Cloud computing for begineers-intern </div>
        </div>
      </div>
    </div>
  </section>
 ...
 target="_blank" class="contact-link">
  ...
  <!-- FOOTER -->
  <footer>
    <p>© 2025 P K Aishwarya· Crafted with ❤️ using HTML, CSS & JavaScript</p>
  </footer>
